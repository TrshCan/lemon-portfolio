                ...
                <>
                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-[70] pointer-events-none px-4">
                        <motion.div
                            ...
                            className={`bg-bg-800 border border-bg-700 rounded-3xl overflow-hidden max-w-2xl w-full shadow-2xl relative pointer-events-auto border-t-4 border-t-accent-${project.accent}`}
                        >
                            {/* Close Button */}
                            <button
                                onClick={onClose}
                                className="absolute top-6 right-6 p-2 text-text-secondary hover:text-accent-primary transition-colors z-20"
                            >
